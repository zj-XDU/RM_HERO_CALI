...
#define FLASH_WRITE_BUF_LENGHT  ( sizeof(gimbal_cali_t) + CALI_LIST_LENGHT * 4)
...
static const uint8_t cali_name[CALI_LIST_LENGHT][3] = {"GM"};

//cali data address
static uint32_t *cali_sensor_buf[CALI_LIST_LENGHT] = {(uint32_t *)&gimbal_cali};


static uint8_t cali_sensor_size[CALI_LIST_LENGHT] ={sizeof(gimbal_cali_t) / 4};

void *cali_hook_fun[CALI_LIST_LENGHT] = {cali_gimbal_hook};
...
/**
  ...
  * @retval         none
  */
void cali_task(void const *pvParameters)
{
    static uint8_t i = 0;
