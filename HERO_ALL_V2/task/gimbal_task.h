...
#define YAW_SPEED_PID_KP        7000.0f		//3600
#define YAW_SPEED_PID_KI        60.0f		//20
...
#define YAW_SPEED_ABSOLUTE_PID_KP        1200.0f//6000.0f//5000.0f		//3600
#define YAW_SPEED_ABSOLUTE_PID_KI        0.0f//60.0f//150.0f		//20
#define YAW_SPEED_ABSOLUTE_PID_KD        0.0f//0.0f     //150.0f
#define YAW_SPEED_ABSOLUTE_PID_MAX_OUT   24000.0f
#define YAW_SPEED_ABSOLUTE_PID_MAX_IOUT  9000.0f
...
#define YAW_GYRO_ABSOLUTE_PID_KP       17.0f //30
#define YAW_GYRO_ABSOLUTE_PID_KI       0.0f //0.00016f
#define YAW_GYRO_ABSOLUTE_PID_KD       0.0f //0.003f
...
#define YAW_RC_ABSOLUTE_SEN    -0.000003f
#define PITCH_RC_SEN  -0.000003f //0.005
...
#define INIT_YAW_SET   1.86992264f	//0.0f
#define INIT_PITCH_SET  -0.264611691f				
...
typedef struct
{
	...
	pid_type_def gimbal_motor_absolute_gyro_pid;
...
typedef struct
{
    ...
    const struct bno055_euler_float_t *gimbal_INT_angle_point;
    const struct bno055_gyro_float_t *gimbal_INT_gyro_point;
    gimbal_motor_t gimbal_yaw_motor;
    gimbal_motor_t gimbal_pitch_motor;
    gimbal_step_cali_t gimbal_cali;
	
	int16_t yaw_current_set;
	int16_t pit_current_set;
	int16_t fric0_current_set;
	int16_t fric1_current_set;
	int16_t trigle_current_set;
